...
var InvalidToolApprovalError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AISDKError"] {
    ...
    constructor({ approvalId }){
        super({
            name: name3,
            message: 'Tool approval response references unknown approvalId: "'.concat(approvalId, '". No matching tool-approval-request found in message history.')
        });
        this[_a3] = true;
...
var ToolCallNotFoundForApprovalError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AISDKError"] {
    ...
    constructor({ toolCallId, approvalId }){
        super({
            name: name5,
            message: 'Tool call "'.concat(toolCallId, '" not found for approval request "').concat(approvalId, '".')
        });
        this[_a5] = true;
...
var MissingToolResultsError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AISDKError"] {
    ...
    constructor({ toolCallIds }){
        super({
            name: name6,
            message: "Tool result".concat(toolCallIds.length > 1 ? "s are" : " is", " missing for tool call").concat(toolCallIds.length > 1 ? "s" : "", " ").concat(toolCallIds.join(", "), ".")
        });
        this[_a6] = true;
...
var marker17 = "vercel.ai.error.".concat(name17);
...
var marker18 = "vercel.ai.error.".concat(name18);
...
var marker19 = "vercel.ai.error.".concat(name19);
...
function formatWarning(param) {
    let { warning, provider, model } = param;
    const prefix = "AI SDK Warning (".concat(provider, " / ").concat(model, "):");
    switch(warning.type){
        case "unsupported":
            {
                let message = "".concat(prefix, ' The feature "').concat(warning.feature, '" is not supported.');
                if (warning.details) {
        ...
        case "compatibility":
            {
                let message = "".concat(prefix, ' The feature "').concat(warning.feature, '" is used in a compatibility mode.');
                if (warning.details) {
                    message += " ".concat(warning.details);
                }
                return message;
...
function logV2CompatibilityWarning(param) {
    let { provider, modelId } = param;
    logWarnings({
        warnings: [
            {
                type: "compatibility",
...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "6.0.145" : "TURBOPACK unreachable";
// src/util/download/download.ts
var download = async (param)=>{
    let { url, maxBytes, abortSignal } = param;
    var _a21;
    const urlText = url.toString();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["validateDownloadUrl"])(urlText);
    try {
        const response = await fetch(urlText, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["withUserAgentSuffix"])({}, "ai-sdk/".concat(VERSION), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getRuntimeEnvironmentUserAgent"])()),
            signal: abortSignal
        });
        if (response.redirected) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["validateDownloadUrl"])(response.url);
        }
        if (!response.ok) {
...
;
async function createToolModelOutput(param) {
    let { toolCallId, input, output, tool: tool2, errorMode } = param;
    if (errorMode === "text") {
        return {
            type: "error-text",
...
async function prepareToolsAndToolChoice(param) {
    ...
    const filteredTools = activeTools != null ? Object.entries(tools).filter((param)=>{
        let [name21] = param;
        return activeTools.includes(name21);
...
function wrapGatewayError(error) {
    ...
    if (isProductionEnv) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AISDKError"]({
            name: "GatewayError",
            message: "Unauthenticated. Configure AI_GATEWAY_API_KEY or use a provider module. Learn more: ".concat(moreInfoURL)
        });
    }
    return Object.assign(new Error("\x1b[1m\x1b[31mUnauthenticated request to AI Gateway.\x1b[0m\n\nTo authenticate, set the \x1b[33mAI_GATEWAY_API_KEY\x1b[0m environment variable with your API key.\n\nAlternatively, you can use a provider module instead of the AI Gateway.\n\nLearn more: \x1b[34m".concat(moreInfoURL, "\x1b[0m\n\n")), {
...
function getBaseTelemetryAttributes(param) {
    ...
    return {
        ...
        ...Object.entries(settings).reduce((attributes, param)=>{
            ...
            if (key === "timeout") {
                ...
                if (totalTimeoutMs != null) {
                    attributes["ai.settings.".concat(key)] = totalTimeoutMs;
                }
            } else {
        ...
        ...Object.entries((_a21 = telemetry == null ? void 0 : telemetry.metadata) != null ? _a21 : {}).reduce((attributes, param)=>{
            let [key, value] = param;
...
;
async function recordSpan(param) {
    let { name: name21, tracer, attributes, fn, endWhenDone = true } = param;
...
async function selectTelemetryAttributes(param) {
...
function collectToolApprovals(param) {
    let { messages } = param;
...
async function executeToolCall(param) {
    let { toolCall, tools, tracer, telemetry, messages, abortSignal, experimental_context, stepNumber, model, onPreliminaryToolResult, onToolCallStart, onToolCallFinish } = param;
...
async function isApprovalNeeded(param) {
    let { tool: tool2, toolCall, messages, experimental_context } = param;
...
var text = ()=>({
        ...
        async parseCompleteOutput (param) {
            let { text: text2 } = param;
            return text2;
        },
        async parsePartialOutput (param) {
            let { text: text2 } = param;
            return {
                partial: text2
            };
...
var object = (param)=>{
    let { schema: inputSchema, name: name21, description } = param;
    ...
    return {
        ...
        async parseCompleteOutput (param, context2) {
            let { text: text2 } = param;
...
var array = (param)=>{
    let { element: inputElementSchema, name: name21, description } = param;
...
var choice = (param)=>{
    let { options: choiceOptions, name: name21, description } = param;
    return {
        name: "choice",
...
var json = function() {
    let { name: name21, description } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return {
        name: "json",
        responseFormat: Promise.resolve({
            type: "json",
...
async function toResponseMessages(param) {
...
async function generateText(param) {
    let { model: modelArg, tools, toolChoice, system, prompt, messages, maxRetries: maxRetriesArg, abortSignal, timeout, headers, stopWhen = stepCountIs(1), experimental_output, output = experimental_output, experimental_telemetry: telemetry, providerOptions, experimental_activeTools, activeTools = experimental_activeTools, experimental_prepareStep, prepareStep = experimental_prepareStep, experimental_repairToolCall: repairToolCall, experimental_download: download2, experimental_context, experimental_include: include, _internal: { generateId: generateId2 = originalGenerateId } = {}, experimental_onStart: onStart, experimental_onStepStart: onStepStart, experimental_onToolCallStart: onToolCallStart, experimental_onToolCallFinish: onToolCallFinish, onStepFinish, onFinish, ...settings } = param;
    ...
    const headersWithUserAgent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["withUserAgentSuffix"])(headers != null ? headers : {}, "ai/".concat(VERSION));
...
async function executeTools(param) {
    let { toolCalls, tools, tracer, telemetry, messages, abortSignal, experimental_context, stepNumber, model, onToolCallStart, onToolCallFinish } = param;
...
function asContent(param) {
    let { content, toolCalls, toolOutputs, toolApprovalRequests, tools } = param;
    const contentParts = [];
    for (const part of content){
        switch(part.type){
            case "text":
                ...
                function getToolInvocation(toolCallId) {
                    ...
                    if (toolInvocation == null) {
                        throw new UIMessageStreamError({
                            ...
                            chunkId: toolCallId,
                            message: 'No tool invocation found for tool call ID "'.concat(toolCallId, '".')
                        });
                    }
                    ...
                    case "text-delta":
                        {
                            ...
                            if (textPart == null) {
                                throw new UIMessageStreamError({
                                    ...
                                    chunkId: chunk.id,
                                    message: 'Received text-delta for missing text part with ID "'.concat(chunk.id, '". Ensure a "text-start" chunk is sent before any "text-delta" chunks.')
                                });
                            }
                    ...
                    case "text-end":
                        {
                            ...
                            if (textPart == null) {
                                throw new UIMessageStreamError({
                                    chunkType: "text-end",
                                    chunkId: chunk.id,
                                    message: 'Received text-end for missing text part with ID "'.concat(chunk.id, '". Ensure a "text-start" chunk is sent before any "text-end" chunks.')
                                });
                            }
                            textPart.state = "done";
                    ...
                    case "reasoning-delta":
                        {
                            ...
                            if (reasoningPart == null) {
                                throw new UIMessageStreamError({
                                    ...
                                    chunkId: chunk.id,
                                    message: 'Received reasoning-delta for missing reasoning part with ID "'.concat(chunk.id, '". Ensure a "reasoning-start" chunk is sent before any "reasoning-delta" chunks.')
                                });
                            }
                    ...
                    case "reasoning-end":
                        {
                            ...
                            if (reasoningPart == null) {
                                throw new UIMessageStreamError({
                                    ...
                                    chunkId: chunk.id,
                                    message: 'Received reasoning-end for missing reasoning part with ID "'.concat(chunk.id, '". Ensure a "reasoning-start" chunk is sent before any "reasoning-end" chunks.')
                                });
                            }
                    ...
                    case "tool-input-delta":
                        {
                            ...
                            if (partialToolCall == null) {
                                throw new UIMessageStreamError({
                                    ...
                                    message: 'Received tool-input-delta for missing tool call with ID "'.concat(chunk.toolCallId, '". Ensure a "tool-input-start" chunk is sent before any "tool-input-delta" chunks.')
                                });
                            }
                            ...
                            if (isDataUIMessageChunk(chunk)) {
                                if ((dataPartSchemas == null ? void 0 : dataPartSchemas[chunk.type]) != null) {
                                    ...
                                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["validateTypes"])({
                                        ...
                                        context: {
                                            field: "message.parts[".concat(actualPartIdx, "].data"),
...
function handleUIMessageStreamFinish(param) {
    let { messageId, originalMessages = [], onStepFinish, onFinish, onError, stream } = param;
...
function runToolsTransformation(param) {
    let { tools, generatorStream, tracer, telemetry, system, messages, abortSignal, repairToolCall, experimental_context, generateId: generateId2, stepNumber, model, onToolCallStart, onToolCallFinish } = param;
    ...
    get elementStream() {
        ...
        if (transform == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UnsupportedFunctionalityError"]({
                functionality: "element streams in ".concat((_c = (_b = this.outputSpecification) == null ? void 0 : _b.name) != null ? _c : "text", " mode")
            });
        }
...
var ToolLoopAgent = class {
   ...
   */ async generate(param) {
        let { abortSignal, timeout, onStepFinish, ...options } = param;
        return generateText({
   ...
   */ async stream(param) {
        let { abortSignal, timeout, experimental_transform, onStepFinish, ...options } = param;
        return streamText({
            ...await this.prepareCall(options),
            abortSignal,
            timeout,
        ...
        if (metadataSchema) {
            for (const [msgIdx, message] of validatedMessages.entries()){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["validateTypes"])({
                    ...
                    context: {
                        field: "messages[".concat(msgIdx, "].metadata"),
                        entityId: message.id
                    }
                });
            }
                        ...
                        if (!dataSchema) {
                            return {
                                ...
                                error: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TypeValidationError"]({
                                    ...
                                    context: {
                                        field: "messages[".concat(msgIdx, "].parts[").concat(partIdx, "].data"),
                                        entityName: dataName,
                    ...
                    if (tools && part.type.startsWith("tool-")) {
                        ...
                        if (!tool2) {
                            return {
                                ...
                                error: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TypeValidationError"]({
                                    ...
                                    context: {
                                        field: "messages[".concat(msgIdx, "].parts[").concat(partIdx, "].input"),
                                        entityName: toolName,
                        ...
                        if (toolPart.state === "output-available" && tool2.outputSchema) {
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["validateTypes"])({
                                ...
                                context: {
                                    field: "messages[".concat(msgIdx, "].parts[").concat(partIdx, "].output"),
                                    entityName: toolName,
                                    entityId: toolPart.toolCallId
                                }
                            });
...
async function createAgentUIStream(param) {
    let { agent, uiMessages, options, abortSignal, timeout, experimental_transform, onStepFinish, ...uiMessageStreamOptions } = param;
    var _a21;
...
async function createAgentUIStreamResponse(param) {
    let { headers, status, statusText, consumeSseStream, ...options } = param;
    return createUIMessageStreamResponse({
        headers,
        status,
        statusText,
...
async function pipeAgentUIStreamToResponse(param) {
    let { response, headers, status, statusText, consumeSseStream, ...options } = param;
    pipeUIMessageStreamToResponse({
        response,
        headers,
        status,
...
async function generateImage(param) {
    let { model: modelArg, prompt: promptArg, n = 1, maxImagesPerCall, size, aspectRatio, seed, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers } = param;
    var _a21, _b;
...
function smoothStream() {
    let { delayInMs = 10, chunking = "word", _internal: { delay: delay2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["delay"] } = {} } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    let detectChunk;
    if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
        ...
        if (chunkingRegex == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InvalidArgumentError"]({
                argument: "chunking",
                message: 'Chunking must be "word", "line", a RegExp, an Intl.Segmenter, or a ChunkDetector function. Received: '.concat(chunking)
            });
        }
        detectChunk = (buffer)=>{
...
async function experimental_generateVideo(param) {
    let { model: modelArg, prompt: promptArg, n = 1, maxVideosPerCall, aspectRatio, resolution, duration, fps, seed, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers, download: downloadFn = defaultDownload } = param;
    var _a21;
...
function defaultEmbeddingSettingsMiddleware(param) {
    let { settings } = param;
    return {
...
function addToolInputExamplesMiddleware() {
    let { prefix = "Input Examples:", format = defaultFormatExample, remove = true } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return {
        specificationVersion: "v3",
        transformParams: async (param)=>{
            let { params } = param;
            ...
            const transformedTools = params.tools.map((tool2)=>{
                ...
                const examplesSection = "".concat(prefix, "\n").concat(formattedExamples);
                const toolDescription = tool2.description ? "".concat(tool2.description, "\n\n").concat(examplesSection) : examplesSection;
                return {
                    ...tool2,
...
var doWrap2 = (param)=>{
    let { model, middleware: { transformParams, wrapEmbed, overrideProvider, overrideModelId, overrideMaxEmbeddingsPerCall, overrideSupportsParallelCalls }, modelId, providerId } = param;
    var _a21, _b, _c, _d;
    async function doTransform(param) {
        let { params } = param;
        return transformParams ? await transformParams({
...
var doWrap3 = (param)=>{
    let { model, middleware: { transformParams, wrapGenerate, overrideProvider, overrideModelId, overrideMaxImagesPerCall }, modelId, providerId } = param;
    var _a21, _b, _c;
    async function doTransform(param) {
        let { params } = param;
        return transformParams ? await transformParams({
...
function wrapProvider(param) {
    let { provider, languageModelMiddleware, imageModelMiddleware } = param;
...
function customProvider(param) {
    let { languageModels, embeddingModels, imageModels, transcriptionModels, speechModels, rerankingModels, videoModels, fallbackProvider: fallbackProviderArg } = param;
...
var marker20 = "vercel.ai.error.".concat(name20);
...
function createProviderRegistry(providers) {
    let { separator = ":", languageModelMiddleware, imageModelMiddleware } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
async function rerank(param) {
    let { model, documents, query, topN, maxRetries: maxRetriesArg, abortSignal, headers, providerOptions, experimental_telemetry: telemetry } = param;
...
async function transcribe(param) {
    let { model, audio, providerOptions = {}, maxRetries: maxRetriesArg, abortSignal, headers, download: downloadFn = defaultDownload2 } = param;
    ...
    try {
        ...
        const response = await fetch2(api, {
            ...
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["withUserAgentSuffix"])({
                ...
                ...headers
            }, "ai-sdk/".concat(VERSION), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getRuntimeEnvironmentUserAgent"])()),
...
var AbstractChat = class {
   ...
   */ get status() {
     ...
     */ this.clearError = ()=>{
        ...
        this.addToolApprovalResponse = async (param)=>{
            let { id, approved, reason, options } = param;
        ...
        this.addToolOutput = async (param)=>{
            let { state = "output-available", toolCallId, output, errorText, options } = param;
            return this.jobExecutor.run(async ()=>{
                const messages = this.state.messages;
                const lastMessage = messages[messages.length - 1];
...
var DirectChatTransport = class {
    async sendMessages(param) {
        let { messages, abortSignal } = param;
        const validatedMessages = await validateUIMessages({
            messages,
...
function lastAssistantMessageIsCompleteWithApprovalResponses(param) {
    let { messages } = param;
