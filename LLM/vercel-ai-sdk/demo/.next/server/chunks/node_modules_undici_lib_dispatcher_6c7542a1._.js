...
"[project]/node_modules/undici/lib/dispatcher/dispatcher1-wrapper.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const Dispatcher = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher.js [app-route] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
const { toRawHeaders } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
class EnvHttpProxyAgent extends DispatcherBase {
    ...
    constructor(opts = {}){
        ...
        const HTTP_PROXY = normalizeProxyUrl(httpProxy ?? process.env.http_proxy ?? process.env.HTTP_PROXY, 'http');
        if (HTTP_PROXY) {
        ...
        const HTTPS_PROXY = normalizeProxyUrl(httpsProxy ?? process.env.https_proxy ?? process.env.HTTPS_PROXY, 'https');
        if (HTTPS_PROXY) {
...
//# sourceMappingURL=node_modules_undici_lib_dispatcher_6c7542a1._.js.map