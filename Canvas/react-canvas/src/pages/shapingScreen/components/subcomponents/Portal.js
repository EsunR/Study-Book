...
export default class Portal extends React.Component {
  ...
  componentWillUnmount() {
    ...
    if (this.defaultNode) {
      if (this.props.targetWrapper && this.props.targetWrapper.contains(this.defaultNode)) {
        this.props.targetWrapper.removeChild(this.defaultNode);
      } else {
        if (document.body.contains(this.defaultNode)) {
